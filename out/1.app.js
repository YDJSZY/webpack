...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	let indexController = __webpack_require__(24);
	let indexFactory = __webpack_require__(25);
	let requestFactory = __webpack_require__(26);
	let indexModule = angular.module('index', ['ui.select', 'ngSanitize']).factory('indexFactory', indexFactory).factory('requestFactory', requestFactory).controller('indexController', ["$scope", "$sce", "indexFactory", "requestFactory", indexController]);
