	    ...
	    $stateProvider.state('index', {
	        ...
	        resolve: {
	            loadIndexController: function ($q, $ocLazyLoad) {
	                ...
	                var indexModule;
	                __webpack_require__.e/* require */(1, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(19), __webpack_require__(20), __webpack_require__(21)]; (function (require) {
	                    indexModule = __webpack_require__(23);
	                    $ocLazyLoad.load({
	        ...
	        resolve: {
	            loadMainController: function ($q, $ocLazyLoad) {
	                ...
	                var deferred = $q.defer();
	                var mainModule = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	let mainController = __webpack_require__(17);
	let mainFactory = __webpack_require__(18);
	let mainModule = angular.module('main', []).factory('mainFactory', mainFactory).controller('mainController', ["$scope", "mainFactory", "loadMainController", mainController]);
